  ...
  return (
    <section className="border-t bg-muted/30 py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 flex flex-col items-center justify-center gap-4 md:flex-row md:items-stretch md:gap-0">
          {steps.map((step, index) => (
            <div key={step.number} className="flex items-center">
              {/* Step card */}
              <div className="group flex w-64 self-stretch flex-col border bg-background p-6 text-center transition-all hover:border-primary/50 hover:shadow-lg">
                {/* Number + Icon */}
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-6 md:gap-10">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground">{t("howItWorks.trustReadOnly")}</span>
          </div>
          <div className="flex items-center gap-2">
            <LockKey className="h-4 w-4 text-muted-foreground" weight="duotone" />
            <span className="text-sm text-muted-foreground">{t("howItWorks.trustNoPassword")}</span>
          </div>
          <div className="flex items-center gap-2">
            <Flag className="h-4 w-4 text-muted-foreground" weight="duotone" />
            <span className="text-sm text-muted-foreground">{t("howItWorks.trustGdpr")}</span>
          </div>
        </div>
      </div>
    </section>
