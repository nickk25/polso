...
export function BankConnectionCard({ connection }: BankConnectionCardProps) {
  ...
  async function handleSync() {
    setSyncing(true)
    // Sync just the first account — the action syncs by Plaid Item, so all accounts in the group get synced
  ...
  async function handleDisconnect() {
    ...
    // Disconnecting any account disconnects the entire Plaid Item
